        ...
        {questions.map((item, index) => (
          <Card key={index} style={{ marginTop: 10 }}>
            <Grid container spacing={2} style={{ padding: 10 }}>
              <GridItem item xs={12}>
                <TextField fullWidth label={`Question ${index + 1}`} />
              ...
              <GridItem item xs={6}>
                ...
                <TextField fullWidth label="Answer 1" onChange={handleChangeAnswer(index)} />
              </GridItem>
              <GridItem item xs={6}>
                <Radio value="1" checked={item.answer === '1'} onChange={handleChangeRadio(index)} />
                <TextField fullWidth label="Answer 2" onChange={handleChangeAnswer(index)} />
              </GridItem>
              <GridItem item xs={6}>
                <Radio value="2" checked={item.answer === '2'} onChange={handleChangeRadio(index)} />
                <TextField fullWidth label="Answer 3" onChange={handleChangeAnswer(index)} />
              </GridItem>
              <GridItem item xs={6}>
                <Radio value="3" checked={item.answer === '3'} onChange={handleChangeRadio(index)} />
                <TextField fullWidth label="Answer 4" onChange={handleChangeAnswer(index)} />
              </GridItem>
            </Grid>
          </Card>
        ))}
